...
function mobileSvg(c, stats, year) {
  ...
  const languageText = stats.languages.length === 0 ? "Language data unavailable" : stats.languages.join(" · ");
